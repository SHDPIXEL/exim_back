...
news: function(req, res) {
  ...
  News.find({$and: [{"date": today_date},{"category_id": req.params.category_id}]}, function(err, data) {
    ...
    if(data != '' && data !== null) {
      ...
      News.findOne({$and: [{"date": today_date},{"category_id": req.params.category_id},{"breaking_news": { $ne: "" }}]}, function(err, breaking_news) {
        if(err) {
          let result = {};
          result.message = "Something Went Wrong.";
          result.error = err;
    ...
    if(data2 != '' && data2 !== null) {
      ...
      News.findOne({$and: [{"date": data1.date},{"category_id": req.params.category_id},{"breaking_news": { $ne: "" }}]}, function(err, breaking_news) {
        if(err) {
          let result = {};
          result.message = "Something Went Wrong.";
          result.error = err;
  ...
  News.find({$and: [{"date": today_date}]}, function(err, data) {
    News.findOne({$and: [{"date": today_date},{"breaking_news": { $ne: "" }}]}, function(error, breaking_news) {
    if(err) {
      let result = {};
      result.message = "Something Went Wrong.";
      result.error = err;
    ...
    News.find({$and: [{"date": data1.date}]}, function(err, data2) {
      News.findOne({$and: [{"date": data1.date},{"breaking_news": { $ne: "" }}]}, function(error, breaking_news) {
    if(err) {
      let result = {};
      result.message = "Something Went Wrong.";
      result.error = err;
...
events: function(req, res) {
  ...
  if(typeof(req.params.status) == "undefined") {
   ...
   Event.find({$and: [{"status": req.params.status}, category_id]}, function(err, data) {
    if(err) {
      let result = {};
      result.message = "Something Went Wrong.";
      result.error = err;
...
break_bulk_sectors: function(req, res) {
    BreakBulkSector.find({"sector_id": req.params.sector_id}, function(err, data) {
    if(err) {
      let result = {};
      result.message = "Something Went Wrong.";
      result.error = err;
...
break_bulk_vessels: function(req, res) {
  ...
  // if(req.params.port_id != -1) {
  BreakBulkVessel.find({$and: [{"date": today_date}, {"break_bulk_sector_id": req.params.break_bulk_sector_id}]}, function(err, data) {
      if(err) {
        let result = {};
        result.message = "Something Went Wrong.";
        result.error = err;
      ...
      if(data != '' && data !== null) {
        ...
        let break_bulk_vessels_data = {};
          ...
          break_bulk_vessels_data.sector_name = break_bulk_vessel.break_bulk_sector_id.name;
          ...
          break_bulk_vessels_data.vessel_name_via_no = break_bulk_vessel.vessel_name_via_no;
          ...
          break_bulk_vessels_data.carting_point = break_bulk_vessel.carting_point;
      ...
      BreakBulkVessel.findOne({$and: [{"date": {$lt:today_date}}]}, function(err, data1) {
        if(err) {
          let result = {};
          result.message = "Something Went Wrong.";
          result.error = err;
        ...
        if(data1 != '' && data1 !== null) {
          BreakBulkVessel.find({$and: [{"date": data1.date}, {"break_bulk_sector_id": req.params.break_bulk_sector_id}]}, function(err, data2) {
              if(err) {
                let result = {};
                result.message = "Something Went Wrong.";
                result.error = err;
...
meet_expert: function(req, res) {
  ...
  // today_date = moment().format('YYYY-MM-DD') + "T00:00:00.000Z";
  QuestionAnswer.find({/*$and: [{"date": today_date}]*/}, function(err, data) {
    if(err) {
      let result = {};
      result.message = "Something Went Wrong.";
      result.error = err;
...
gazette_vessels: function(req, res) {
  ...
  // if(req.params.port_id != -1) {
  GazetteVessel.find({$and: [{"date": today_date}, {"service_id": req.params.service_id}]}, function(err, data) {
    GazetteLineAgent.find({$and: [{"service_id": req.params.service_id}]}, function(err, lines) {
      if(err) {
        let result = {};
        result.message = "Something Went Wrong.";
        result.error = err;
      ...
      if(data != '' && data !== null) {
        ...
        data.map(function(vessels) {
          ...
          if(vessels.gazette_sector_id == '1') {
            ...
            gazette_vessels_data[vessels.order+'-'+vessels.item] = vessels.desc_one;
          });
           var ordered = {};
          ...
          var gazette_vessels_data = {};
            data.map(function(vessels) {
              ...
              if(vessels.gazette_sector_id == '1') {
                ...
                // gazette_vessels_data.desc_two = vessels.desc_two;
                gazette_vessels_data.date = vessels.date;
                gazette_vessels_data[vessels.order+'-'+vessels.item] = vessels.desc_two;
              });
                var ordered = {};
                  Object.keys(gazette_vessels_data).forEach(function(key) {
                    var split = key.split('-')[1];
      ...
      GazetteVessel.findOne({$and: [{"date": {$lt:today_date}}]}, function(err, data1) {
        if(err) {
          let result = {};
          result.message = "Something Went Wrong.";
          result.error = err;
        ...
        if(data1 != '' && data1 !== null) {
          GazetteVessel.find({$and: [{"date": data1.date}, {"service_id": req.params.service_id}]}, function(err, data2) {
            GazetteLineAgent.find({$and: [{"service_id": req.params.service_id}]}, function(err, lines) {
              if(err) {
                let result = {};
                result.message = "Something Went Wrong.";
          ...
          }).sort({'order': 1}).populate('sector_id', 'name').populate('port_id', 'name');
        } else {
            let result = {};
            result.message = "No Record Found.";
            result.success = 0;
